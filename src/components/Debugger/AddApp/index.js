...
class AddApp extends Component {
  ...
  openDocs() {
    shell.openExternal('https://cerebraljs.com/docs/introduction/devtools.html')
  }
  openSsl() {
    shell.openExternal(
      ...
      <div>
        <div className="app-disabled">
              ...
              >
                <span>
                  ...
                  <ol>
                    <li>
                      Go to{' '}
                      <a href="#" onClick={this.openSsl}>
                        create-ssl-certificate
                      </a>
                    </li>
                    <li>
                      Create certificate on hostname: <b>cerebral-debugger</b>
                    </li>
                    <li>Drop the created {this.getSslText()}</li>
                    <li>
                      Connect with host: <b>cerebral-debugger.dev</b> and port
                    </li>
                  </ol>
                </span>
              </div>
          ...
          <div className="requirementsList">
            ...
            <a onClick={this.openDocs}>at the Cerebral website</a>
          </div>
        </div>
      </div>
    )
