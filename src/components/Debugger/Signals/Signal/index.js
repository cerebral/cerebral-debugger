...
export default connect(
  ...
  class Signal extends Component {
    ...
    renderAction(action, index) {
      ...
      const executedBySignals =
        ...
        this.props.signal.functionsRun[action.functionIndex].executedIds.length
          ? this.props.signal.functionsRun[
      ...
      return (
        <div className="action-container">
          ...
          execution &&
          execution.payload &&
          Object.keys(execution.payload).length ? (
            <Props
    ...
    render() {
      ...
      return (
        <div
          className={classnames('signal', this.props.className)}
          style={this.props.style}
        >
          {this.props.executedBy ? (
            <div
              className="executedByLine"
            ...
            <div className="signal-settingsContainer">
              ...
              {this.props.executedBy ? null : (
                <label>
                  ...
                  <input
                    type="checkbox"
                    onChange={() => this.props.showPropsToggled()}
                    checked={this.props.showProps}
                  />
                </label>
              )}
            </div>
          </h3>
          <div id="signal" className="signal-container">
            {this.renderSequence(this.props.signal.staticTree)}
          </div>
          {this.props.executedBy ? (
            <div
              className="executedByLine"
